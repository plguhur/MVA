"""
See https://www.kymat.io/gallery_2d/cifar_resnet.html#sphx-glr-gallery-2d-cifar-resnet-py for details
"""
...
class ScatteringCIFAR10(SubCIFAR10):
    def __init__(self, *args, scattering=None, **kwargs):
        if scattering is None:
            raise ArgumentError("Please provide a scattering method")
        self.scattering = scattering
        super().__init__(*args, **kwargs)
        
    def __getitem__(self, index):
        return self.scattering(super().__getitem__(index))
